<x-admin-layout title="Add New Tag">
    ...
    <div class="space-y-6" x-data="{ 
        ...
        isTrending: {{ old('is_trending') ? 'true' : 'false' }}
    }">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <h1 class="text-xl font-black text-slate-900 dark:text-white tracking-tight">Create Hashtag / Topic Tag</h1>
        ...
        <form action="{{ route('admin.tags.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            @csrf
