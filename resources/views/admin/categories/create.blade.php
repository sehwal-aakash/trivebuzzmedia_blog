<x-layout>
    <x-slot:title>
        Admin: Add Category - {{ config('app.name', 'TriveBuzz Media') }}
    </x-slot>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mt-4">Add Category</h1>
        </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-form.textarea name="description" id="description" rows="4">{{ old('description') }}</x-form.textarea>
                        @error('description')
                            <p class="mt-1 text-xs text-red-600 font-bold uppercase tracking-tight">{{ $message }}</p>
                        @enderror
                    </div>
